    ...
    if (goog.inHtmlDocument_()) {
        ...
        if (void 0 === b)
            if (goog.IS_OLD_IE_) {
                ...
                c.write('<script type="text/javascript" src="' + a + '"' + d + "></script>")
            } else goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING ? goog.appendScriptSrcNode_(a) : goog.writeScriptSrcNode_(a);
        else c.write('<script type="text/javascript">' + goog.protectScriptTag_(b) + "</script>");
        return !0
    }
    return !1
}, goog.protectScriptTag_ = function(a) {
    return a.replace(/<\/(SCRIPT)/ig, "\</$1")
...
goog.string.htmlEscape = function(a, b) {
    if (b) a = a.replace(goog.string.AMP_RE_, "&amp;").replace(goog.string.LT_RE_, "&lt;").replace(goog.string.GT_RE_, "&gt;").replace(goog.string.QUOT_RE_, "&quot;").replace(goog.string.SINGLE_QUOTE_RE_, "&#39;").replace(goog.string.NULL_RE_, "&#0;"), goog.string.DETECT_DOUBLE_ESCAPING && (a = a.replace(goog.string.E_RE_, "&#101;"));
        ...
        if (!goog.string.ALL_RE_.test(a)) return a; - 1 != a.indexOf("&") && (a = a.replace(goog.string.AMP_RE_, "&amp;")); - 1 != a.indexOf("<") && (a = a.replace(goog.string.LT_RE_, "&lt;")); - 1 != a.indexOf(">") && (a = a.replace(goog.string.GT_RE_, "&gt;")); - 1 != a.indexOf('"') && (a = a.replace(goog.string.QUOT_RE_, "&quot;")); - 1 != a.indexOf("'") && (a = a.replace(goog.string.SINGLE_QUOTE_RE_, "&#39;")); - 1 != a.indexOf("") && (a = a.replace(goog.string.NULL_RE_, "&#0;"));
...
goog.string.regExpEscape = function(a) {
    return String(a).replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g, "\\$1").replace(//g, "\")
};
...
goog.string.compareVersions = function(a, b) {
    for (var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0; 0 == c && g < f; g++) {
        ...
        do {
            ...
            c = goog.string.compareElements_(c, n) || goog.string.compareElements_(0 == h[2].length, 0 == k[2].length) || goog.string.compareElements_(h[2], k[2]);
            h = h[3];
            k = k[3]
        } while (0 == c)
    }
...
goog.debug.freezeInternal_ = goog.DEBUG && Object.freeze ||
    function(a) {
        return a
    };
...
goog.html.TrustedResourceUrl.formatWithParams = function(a, b, c) {
    ...
    b = /\?/.test(a) ? "&" : "?";
    for (var d in c)
        for (var e = goog.isArray(c[d]) ? c[d] : [c[d]], f = 0; f < e.length; f++) null != e[f] && (a += b + encodeURIComponent(d) + "=" + encodeURIComponent(String(e[f])), b = "&");
...
goog.style.getOffsetParent = function(a) {
    ...
    for (a = a.parentNode; a && a != b; a = a.parentNode)
        if (a.nodeType == goog.dom.NodeType.DOCUMENT_FRAGMENT && a.host && (a = a.host), c = goog.style.getStyle_(a, "position"), d = d && "static" == c && a != b.documentElement && a != b.body, !d && (a.scrollWidth > a.clientWidth || a.scrollHeight > a.clientHeight || "fixed" == c || "absolute" == c || "relative" == c)) return a;
    return null
};
...
goog.events.KeyCodes.firesKeyPressEvent = function(a, b, c, d, e, f) {
    ...
    if ((!c || goog.userAgent.MAC) && e || goog.userAgent.MAC && f) return !1;
...
goog.events.KeyHandler.prototype.handleKeyDown_ = function(a) {
    (goog.userAgent.WEBKIT || goog.userAgent.EDGE) && (this.lastKey_ == goog.events.KeyCodes.CTRL && !a.ctrlKey || this.lastKey_ == goog.events.KeyCodes.ALT && !a.altKey || goog.userAgent.MAC && this.lastKey_ == goog.events.KeyCodes.META && !a.metaKey) && this.resetState(); - 1 == this.lastKey_ && (a.ctrlKey && a.keyCode != goog.events.KeyCodes.CTRL ? this.lastKey_ = goog.events.KeyCodes.CTRL : a.altKey && a.keyCode != goog.events.KeyCodes.ALT ? this.lastKey_ = goog.events.KeyCodes.ALT : a.metaKey && a.keyCode != goog.events.KeyCodes.META && (this.lastKey_ = goog.events.KeyCodes.META));
...
goog.events.KeyHandler.prototype.handleEvent = function(a) {
    ...
    } else(goog.userAgent.WEBKIT || goog.userAgent.EDGE) && a.type == goog.events.EventType.KEYPRESS ? (d = this.keyCode_, e = 0 <= b.charCode && 63232 > b.charCode && goog.events.KeyCodes.isCharacterKey(d) ? b.charCode : 0) : goog.userAgent.OPERA && !goog.userAgent.WEBKIT ? (d = this.keyCode_, e = goog.events.KeyCodes.isCharacterKey(d) ? b.keyCode : 0) : (d = b.keyCode || this.keyCode_, e = b.charCode || 0, goog.events.KeyHandler.SAVE_ALT_FOR_KEYPRESS_ && (c = this.altKey_), goog.userAgent.MAC && e == goog.events.KeyCodes.QUESTION_MARK && d == goog.events.KeyCodes.WIN_KEY && (d = goog.events.KeyCodes.SLASH));
...
goog.ui.MenuItemRenderer.prototype.getClassForState = function(a) {
    switch (a) {
        case goog.ui.Component.State.CLICK:
...
goog.ui.tree.BaseNode.prototype.addChildAt = function(a, b, c) {
    ...
    if (b = this.getElement())
        if (this.updateExpandIcon(), goog.a11y.aria.setState(b, goog.a11y.aria.State.EXPANDED, this.getExpanded()), this.getExpanded()) {
        ...
        if (this.hasChildren()) {
            if (!a && c && this.contains(c.getSelectedItem()) && this.select(), d) {
                if (c = this.getChildrenElement())
                    if (goog.style.setElementShown(c, a), goog.a11y.aria.setState(d, goog.a11y.aria.State.EXPANDED, a), a && this.isInDocument() && !c.hasChildNodes()) {
                        var e = [];
                        this.forEachChild(function(a) {
                            e.push(a.toSafeHtml())
                        });
...
Blockly.VariableMap.prototype.renameVariable = function(a, b) {
    ...
    a && (d = g.indexOf(a));
    c && (e = g.indexOf(c)); - 1 == d && -1 == e ? (this.createVariable(b, ""), console.log("Tried to rename an non-existent variable.")) : d == e || -1 != d && -1 == e ? (c = this.variableMap_[f][d], Blockly.Events.fire(new Blockly.Events.VarRename(c, b)), c.name = b) : -1 != d && -1 != e && (c = this.variableMap_[f][e], Blockly.Events.fire(new Blockly.Events.VarRename(c, b)), Blockly.Events.fire(new Blockly.Events.VarDelete(this.variableMap_[f][d])), c.name = b, this.variableMap_[f].splice(d, 1))
};
...
Blockly.Workspace.prototype.deleteVariable = function(a) {
    ...
    var e = this,
        f = e.getVariable(a);
    1 < b.length ? Blockly.confirm(Blockly.Msg.DELETE_VARIABLE_CONFIRMATION.replace("%1", b.length).replace("%2", a), function(a) {
...
Blockly.Workspace.prototype.deleteVariableById = function(a) {
    ...
    b ? this.deleteVariableInternal_(b) : console.warn("Can't delete non-existant variable: " + a)
};
...
Blockly.Comment.prototype.setVisible = function(a) {
    if (a != this.isVisible())
        if (Blockly.Events.fire(new Blockly.Events.Ui(this.block_, "commentOpen", !a, a)), !this.block_.isEditable() && !this.textarea_ || goog.userAgent.IE) Blockly.Warning.prototype.setVisible.call(this, a);
            ...
            a ? (this.bubble_ = new Blockly.Bubble(this.block_.workspace, this.createEditor_(), this.block_.svgPath_, this.iconXY_, this.width_, this.height_), this.bubble_.registerResizeEvent(this.resizeBubble_.bind(this)), this.updateColour()) : (this.bubble_.dispose(), this.foreignObject_ = this.textarea_ = this.bubble_ = null);
            this.setText(b);
...
Blockly.Extensions.mutatorPropertiesMatch_ = function(a, b) {
    var c = !0,
        d = Blockly.Extensions.getMutatorProperties_(b);
    if (d.length != a.length) c = !1;
    else
        for (var e = 0; e < d.length; e++) a[e] != d[e] && (c = !1);
    return c
};
...
Blockly.BlockDragger.prototype.startBlockDrag = function(a) {
    ...
    this.workspace_.toolbox_ && this.workspace_.toolbox_.addDeleteStyle()
};
...
Blockly.Field.prototype.init = function() {
    ...
    }, this.fieldGroup_), this.updateEditable(), this.sourceBlock_.getSvgRoot().appendChild(this.fieldGroup_), this.mouseDownWrapper_ = Blockly.bindEventWithChecks_(this.fieldGroup_, "mousedown", this, this.onMouseDown_), this.render_())
};
...
Blockly.utils.getRelativeXY = function(a) {
    ...
    (a = a.getAttribute("style")) && -1 < a.indexOf("translate") && ((c = a.match(Blockly.utils.getRelativeXY.XY_2D_REGEX_)) || (c = a.match(Blockly.utils.getRelativeXY.XY_3D_REGEX_)), c && (b.x += parseFloat(c[1]), c[3] && (b.y += parseFloat(c[3]))));
    return b
};
Blockly.utils.getInjectionDivXY_ = function(a) {
    for (var b = 0, c = 0, d; a;) {
        var e = Blockly.utils.getRelativeXY(a);
        d = Blockly.utils.getScale_(a);
        b = b * d + e.x;
        c = c * d + e.y;
...
Blockly.utils.checkMessageReferences = function(a) {
    for (var b = !0, c = /%{BKY_([a-zA-Z][a-zA-Z0-9_]*)}/g, d = c.exec(a); null != d;) {
        var e = d[1];
        null == Blockly.utils.getMessageArray_()[e] && (console.log("WARNING: No message string for %{BKY_" + e + "}."), b = !1);
        a = a.substring(d.index + e.length + 1);
        d = c.exec(a)
    }
    return b
};
...
Blockly.Options = function(a) {
    ...
    l = "end" === l ? !1 : !0;
    l = p ? l ? Blockly.TOOLBOX_AT_TOP : Blockly.TOOLBOX_AT_BOTTOM : l == n ? Blockly.TOOLBOX_AT_RIGHT : Blockly.TOOLBOX_AT_LEFT;
    var m = a.scrollbars;
    void 0 === m && (m = d);
    var q = a.css;
    void 0 === q && (q = !0);
...
goog.events.BrowserFeature.TOUCH_ENABLED && (Blockly.Scrollbar.scrollbarThickness = 10);
...
Blockly.WorkspaceDragSurfaceSvg.prototype.clearAndHide = function(a) {
    ...
    goog.asserts.assert(0 == this.SVG_.childNodes.length, "Drag surface was not cleared.");
...
Blockly.Xml.blockToDom = function(a, b) {
    ...
    for (var e; e = a.inputList[d]; d++)
        for (var f = 0, g; g = e.fieldRow[f]; f++) {
            var h = g;
            h.name && h.EDITABLE && (g = goog.dom.createDom("field", null, h.getValue()), g.setAttribute("name", h.name), h instanceof Blockly.FieldVariable && (h = a.workspace.getVariable(h.getValue())) && (g.setAttribute("id", h.getId()), g.setAttribute("variableType", h.type)), c.appendChild(g))
        }
    ...
    try {
        for (var h = 0; h < e; h++) {
            ...
            if ("block" == n || "shadow" == n && !Blockly.Events.recordUndo) {
                var p = Blockly.Xml.domToBlock(k, b);
                c.push(p.id);
...
Blockly.Xml.appendDomToWorkspace = function(a, b) {
    ...
    if (d && d.height) {
        ...
        var n;
        b.RTL && (n = b.getWidth());
        for (d = 0; d < c.length; d++) b.getBlockById(c[d]).moveBy(b.RTL ? n - f : f, e)
    }
    return c
};
...
Blockly.Xml.domToBlockHeadless_ = function(a, b) {
    ...
    for (var f = null, g = 0, h; h = a.childNodes[g]; g++)
        if (3 != h.nodeType) {
            ...
            switch (h.nodeName.toLowerCase()) {
                case "mutation":
                    c.domToMutation && (c.domToMutation(h), c.initSvg && c.initSvg());
                    break;
                case "comment":
                ...
                case "next":
                    ...
                    k && (goog.asserts.assert(c.nextConnection, "Next statement does not exist."), goog.asserts.assert(!c.nextConnection.isConnected(), "Next statement is already connected."), f = Blockly.Xml.domToBlockHeadless_(k, b), goog.asserts.assert(f.previousConnection, "Next block does not have previous statement."), c.nextConnection.connect(f.previousConnection));
                    break;
                default:
    ...
    (g = a.getAttribute("editable")) && c.setEditable("true" == g);
...
Blockly.ZoomControls.prototype.createDom = function() {
    ...
    Blockly.bindEventWithChecks_(c, "mousedown", null, function(b) {
        a.markFocused();
...
Blockly.WorkspaceSvg.prototype.zoom = function(a, b, c) {
    ...
    this.scale != c && (this.scrollbar && (a = f.getCTM().translate(a * (1 - d), b * (1 - d)).scale(d), this.scrollX = a.e - e.absoluteLeft, this.scrollY = a.f - e.absoluteTop), this.setScale(c))
};
...
Blockly.WorkspaceSvg.getTopLevelWorkspaceMetrics_ = function() {
    ...
    var d = Blockly.WorkspaceSvg.getContentDimensions_(this, c),
        e = 0;
...
Blockly.Block.prototype.setColour = function(a) {
    ...
    else if (goog.isString(a) && a.match(/^#[0-9a-fA-F]{6}$/)) this.colour_ = a, this.hue_ = null;
...
Blockly.Block.prototype.jsonInit = function(a) {
    ...
    goog.isString(a.extensions) && (console.warn("JSON attribute 'extensions' should be an array of strings. Found raw string in JSON for '" + a.type + "' block."), a.extensions = [a.extensions]);
...
Blockly.BlockSvg.prototype.renderCompute_ = function(a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, n = this.getInputsInline() && !this.isCollapsed(), p = 0, l; l = b[p]; p++)
        if (l.isVisible()) {
            ...
            else k = l.type, m = [], m.type = n && l.type != Blockly.NEXT_STATEMENT ? Blockly.BlockSvg.INLINE : l.type, m.height = 0, c.push(m);
            m.push(l);
            ...
            n || p != b.length - 1 ? !n && l.type == Blockly.INPUT_VALUE && b[p + 1] && b[p + 1].type == Blockly.NEXT_STATEMENT && l.renderHeight-- : l.renderHeight--;
            ...
            m.type != Blockly.BlockSvg.INLINE && (m.type == Blockly.NEXT_STATEMENT ? (g = !0, e = Math.max(e, l.fieldWidth)) : (m.type == Blockly.INPUT_VALUE ? f = !0 : m.type == Blockly.DUMMY_INPUT && (h = !0), d = Math.max(d, l.fieldWidth)))
        }
    for (a = 0; m = c[a]; a++)
...
Blockly.BlockSvg.prototype.renderDraw_ = function(a, b) {
    ...
    if (this.outputConnection) this.squareBottomLeftCorner_ = this.squareTopLeftCorner_ = !0;
        ...
        } else Blockly.BlockSvg.START_HAT && (this.startHat_ = this.squareTopLeftCorner_ = !0, this.height += Blockly.BlockSvg.START_HAT_HEIGHT, b.rightEdge = Math.max(b.rightEdge, 100));
    ...
    for (var d = [], e = Object.create(null), f = 0, g; g = c[f]; f++)
        if (!g.isNull()) {
            var h = [g.type, g.blockId, g.workspaceId].join(" "),
                k = e[h];
            k ? g.type == Blockly.Events.MOVE ? (k.newParentId = g.newParentId, k.newInputName = g.newInputName, k.newCoordinate = g.newCoordinate) : g.type == Blockly.Events.CHANGE && g.element == k.element && g.name == k.name ? k.newValue = g.newValue : g.type != Blockly.Events.UI || "click" != g.element || "commentOpen" != k.element && "mutatorOpen" != k.element && "warningOpen" != k.element || (k.newValue = g.newValue) : (e[h] = g, d.push(g))
        }
    c = d;
    b || c.reverse();
...
Blockly.Events.disableOrphans = function(a) {
    if (a.type == Blockly.Events.MOVE || a.type == Blockly.Events.CREATE) {
        ...
        if (a = b.getBlockById(a.blockId))
            ...
            do a.setDisabled(!0), a = a.getNextBlock();
            while (a)
        }
        Blockly.Events.enable()
    }
...
Blockly.FieldDropdown.prototype.addTouchEndListener_ = function(a) {
    a.getHandler().listen(a.getElement(), goog.events.EventType.CLICK, function(a) {
...
Blockly.FieldDropdown.prototype.trimOptions_ = function() {
    ...
    if (goog.isArray(a)) {
        ...
        if (!(b || 2 > a.length)) {
            ...
            var e = Blockly.utils.commonWordSuffix(b, c);
...
Blockly.Variables.flyoutCategoryBlocks = function(a) {
    ...
    if (0 < a.length) {
        ...
        Blockly.Blocks.math_change && (d = Blockly.Blocks.variables_get ? 20 : 8, d = '<xml><block type="math_change" gap="' + d + '">' + Blockly.Variables.generateVariableFieldXml_(c) + '<value name="DELTA"><shadow type="math_number"><field name="NUM">1</field></shadow></value></block></xml>', d = Blockly.Xml.textToDom(d).firstChild, b.push(d));
...
Blockly.Variables.promptName = function(a, b, c) {
    Blockly.prompt(a, b, function(a) {
        a && (a = a.replace(/[\s ]+/g, " ").replace(/^ | $/g, ""), a == Blockly.Msg.RENAME_VARIABLE || a == Blockly.Msg.NEW_VARIABLE) && (a = null);
        c(a)
    })
};
...
Blockly.Generator.prototype.provideFunction_ = function(a, b) {
    if (!this.definitions_[a]) {
        ...
        for (var d; d != c;) d = c, c = c.replace(/^((  )*)  /gm, "$1");
...
Blockly.FlyoutButton.prototype.createDom = function() {
    ...
    this.width = c.getComputedTextLength();
    this.height = 20;
...
Blockly.Flyout.prototype.show = function(a) {
    ...
    for (var b = [], c = [], d = this.permanentlyDisabled_.length = 0, e; e = a[d]; d++)
        if (e.tagName) {
            ...
            else if ("BUTTON" == f || "LABEL" == f) e = new Blockly.FlyoutButton(this.workspace_, this.targetWorkspace_, e, "LABEL" == f), b.push({
                type: "button",
                button: e
            }), c.push(g)
        }
...
Blockly.Flyout.prototype.clearOldBlocks_ = function() {
    ...
    for (b = 0; b < this.backgroundButtons_.length; b++)(a = this.backgroundButtons_[b]) && goog.dom.removeNode(a);
...
Blockly.Flyout.prototype.createRect_ = function(a, b, c, d, e) {
    ...
    a.flyoutRect_ = b;
    return this.backgroundButtons_[e] = b
};
...
Blockly.HorizontalFlyout.prototype.reflowInternal_ = function(a) {
    this.workspace_.scale = this.targetWorkspace_.scale;
    ...
    if (this.height_ != b) {
        for (c = 0; d = a[c]; c++) d.flyoutRect_ && this.moveRectToBlock_(d.flyoutRect_, d);
        this.height_ = b;
...
Blockly.VerticalFlyout.prototype.reflowInternal_ = function(a) {
    this.workspace_.scale = this.targetWorkspace_.scale;
    ...
    if (this.width_ != b) {
        for (c = 0; d = a[c]; c++) {
            if (this.RTL) {
                ...
                var f = b / this.workspace_.scale - this.MARGIN;
                f -= Blockly.BlockSvg.TAB_WIDTH;
                d.moveBy(f - e, 0)
            }
...
Blockly.Toolbox.prototype.addColour_ = function(a) {
    ...
    for (var b = 0, c; c = a[b]; b++) {
        ...
        if (d) {
            var e = this.hasColours_ ? "3px solid " + (c.hexColour || "#ddd") : "none";
...
Blockly.Css.CONTENT = [".blocklySvg {", "background-color: #fff;", "outline: none;", "overflow: hidden;", "position: absolute;", "display: block;", "}", ".blocklyWidgetDiv {", "display: none;", "position: absolute;", "z-index: 99999;", "}", ".injectionDiv {", "height: 100%;", "position: relative;", "overflow: hidden;", "touch-action: none", "}", ".blocklyNonSelectable {", "user-select: none;", "-moz-user-select: none;", "-webkit-user-select: none;", "-ms-user-select: none;", "}", ".blocklyWsDragSurface {", "display: none;", "position: absolute;", "top: 0;", "left: 0;", "}", ".blocklyWsDragSurface.blocklyOverflowVisible {", "overflow: visible;", "}", ".blocklyBlockDragSurface {", "display: none;", "position: absolute;", "top: 0;", "left: 0;", "right: 0;", "bottom: 0;", "overflow: visible !important;", "z-index: 50;", "}", ".blocklyTooltipDiv {", "background-color: #ffffc7;", "border: 1px solid #ddc;", "box-shadow: 4px 4px 20px 1px rgba(0,0,0,.15);", "color: #000;", "display: none;", "font-family:'Microsoft Yahei',sans-serif;", "font-size: 9pt;", "opacity: 0.9;", "padding: 2px;", "position: absolute;", "z-index: 100000;", "}", ".blocklyResizeSE {", "cursor: se-resize;", "fill: #aaa;", "}", ".blocklyResizeSW {", "cursor: sw-resize;", "fill: #aaa;", "}", ".blocklyResizeLine {", "stroke: #888;", "stroke-width: 1;", "}", ".blocklyHighlightedConnectionPath {", "fill: none;", "stroke: #fc3;", "stroke-width: 4px;", "}", ".blocklyPathLight {", "fill: none;", "stroke-linecap: round;", "stroke-width: 0;", "}", ".blocklySelected>.blocklyPath {", "stroke: #fc3;", "stroke-width: 3px;", "}", ".blocklySelected>.blocklyPathLight {", "display: none;", "}", ".blocklyDraggable {", 'cursor: url("<<<PATH>>>/handopen.cur"), auto;', "cursor: grab;", "cursor: -webkit-grab;", "cursor: -moz-grab;", "}", ".blocklyDragging {", 'cursor: url("<<<PATH>>>/handclosed.cur"), auto;', "cursor: grabbing;", "cursor: -webkit-grabbing;", "cursor: -moz-grabbing;", "}", ".blocklyDraggable:active {", 'cursor: url("<<<PATH>>>/handclosed.cur"), auto;', "cursor: grabbing;", "cursor: -webkit-grabbing;", "cursor: -moz-grabbing;", "}", ".blocklyBlockDragSurface .blocklyDraggable {", 'cursor: url("<<<PATH>>>/handclosed.cur"), auto;', "cursor: grabbing;", "cursor: -webkit-grabbing;", "cursor: -moz-grabbing;", "}", ".blocklyDragging.blocklyDraggingDelete {", 'cursor: url("<<<PATH>>>/handdelete.cur"), auto;', "}", ".blocklyToolboxDelete {", 'cursor: url("<<<PATH>>>/handdelete.cur"), auto;', "}", ".blocklyDragging>.blocklyPath,", ".blocklyDragging>.blocklyPathLight {", "fill-opacity: .8;", "stroke-opacity: .8;", "}", ".blocklyDragging>.blocklyPathDark {", "display: none;", "}", ".blocklyDisabled>.blocklyPath {", "fill-opacity: .5;", "stroke-opacity: .5;", "}", ".blocklyDisabled>.blocklyPathLight,", ".blocklyDisabled>.blocklyPathDark {", "display: none;", "}", ".blocklyText {", "cursor: default;", "fill: #fff;", "font-family:'Microsoft Yahei',sans-serif;", "font-size: 9pt;", "}", ".blocklyNonEditableText>text {", "pointer-events: none;", "}", ".blocklyNonEditableText>rect,", ".blocklyEditableText>rect {", "fill: #fff;", "fill-opacity: .6;", "}", ".blocklyNonEditableText>text,", ".blocklyEditableText>text {", "fill: #000;", "}", ".blocklyEditableText:hover>rect {", "stroke: #fff;", "stroke-width: 2;", "}", ".blocklyBubbleText {", "fill: #000;", "}", ".blocklyFlyout {", "position: absolute;", "z-index: 20;", "}", ".blocklyFlyoutButton {", "fill: #888;", "cursor: default;", "}", ".blocklyFlyoutButtonShadow {", "fill: #666;", "}", ".blocklyFlyoutButton:hover {", "fill: #aaa;", "}", ".blocklyFlyoutLabel {", "cursor: default;", "}", ".blocklyFlyoutLabelBackground {", "opacity: 0;", "}", ".blocklyFlyoutLabelText {", "fill: #000;", "}", ".blocklySvg text, .blocklyBlockDragSurface text {", "user-select: none;", "-moz-user-select: none;", "-webkit-user-select: none;", "cursor: inherit;", "}", ".blocklyHidden {", "display: none;", "}", ".blocklyFieldDropdown:not(.blocklyHidden) {", "display: block;", "}", ".blocklyIconGroup {", "cursor: default;", "}", ".blocklyIconGroup:not(:hover),", ".blocklyIconGroupReadonly {", "opacity: .6;", "}", ".blocklyIconShape {", "fill: #00f;", "stroke: #fff;", "stroke-width: 1px;", "}", ".blocklyIconSymbol {", "fill: #fff;", "}", ".blocklyMinimalBody {", "margin: 0;", "padding: 0;", "}", ".blocklyCommentTextarea {", "background-color: #ffc;", "border: 0;", "margin: 0;", "padding: 2px;", "resize: none;", "}", ".blocklyHtmlInput {", "border: none;", "border-radius: 4px;", "font-family:'Microsoft Yahei',sans-serif;", "height: 100%;", "margin: 0;", "outline: none;", "padding: 0 1px;", "width: 100%", "}", ".blocklyMainBackground {", "stroke-width: 0;", "stroke: #c6c6c6;", "}", ".blocklyMutatorBackground {", "fill: #fff;", "stroke: #ddd;", "stroke-width: 1;", "}", ".blocklyFlyoutBackground {", "fill: #ececec;", "fill-opacity: .7;", "}", ".blocklyTransparentBackground {", "opacity: 0;", "}", ".blocklyMainWorkspaceScrollbar {", "z-index: 20;", "}", ".blocklyFlyoutScrollbar {", "z-index: 30;", "}", ".blocklyScrollbarHorizontal, .blocklyScrollbarVertical {", "position: absolute;", "outline: none;", "}", ".blocklyScrollbarBackground {", "opacity: 0;", "}", ".blocklyScrollbarHandle {", "fill: #ccc;", "}", ".blocklyScrollbarBackground:hover+.blocklyScrollbarHandle,", ".blocklyScrollbarHandle:hover {", "fill: #bbb;", "}", ".blocklyZoom>image {", "opacity: .8;", "}", ".blocklyZoom>image:hover {", "opacity: .8;", "}", ".blocklyZoom>image:active {", "opacity: .9;", "}", ".blocklyFlyout .blocklyScrollbarHandle {", "fill: #bbb;", "}", ".blocklyFlyout .blocklyScrollbarBackground:hover+.blocklyScrollbarHandle,", ".blocklyFlyout .blocklyScrollbarHandle:hover {", "fill: #aaa;", "}", ".blocklyInvalidInput {", "background: #faa;", "}", ".blocklyAngleCircle {", "stroke: #444;", "stroke-width: 1;", "fill: #ddd;", "fill-opacity: .8;", "}", ".blocklyAngleMarks {", "stroke: #444;", "stroke-width: 1;", "}", ".blocklyAngleGauge {", "fill: #f88;", "fill-opacity: .8;", "}", ".blocklyAngleLine {", "stroke: #f00;", "stroke-width: 2;", "stroke-linecap: round;", "pointer-events: none;", "}", ".blocklyContextMenu {", "border-radius: 4px;", "}", ".blocklyDropdownMenu {", "padding: 0 !important;", "}", ".blocklyWidgetDiv .goog-option-selected .goog-menuitem-checkbox,", ".blocklyWidgetDiv .goog-option-selected .goog-menuitem-icon {", "background: url(<<<PATH>>>/sprites.png) no-repeat -48px -16px !important;", "}", ".blocklyToolboxDiv {", "background-color: #f5f5f5;", "overflow-x: hidden;", "overflow-y: hidden;", "position: absolute;", "z-index: 70;", "-webkit-tap-highlight-color: transparent;", "}", ".blocklyTreeRoot {", "padding: 0px;", "}", ".blocklyTreeRoot:focus {", "outline: none;", "}", ".blocklyTreeRow {", "height: 50px;", "line-height: 50px;", "margin-top:0px;", "padding-right: 0px;", "white-space: nowrap;", "}", ".blocklyHorizontalTree {", "float: left;", "margin: 8px 7px;", "}", ".blocklyHorizontalTreeRtl {", "float: right;", "margin: 1px 0 8px 5px;", "}", '.blocklyToolboxDiv[dir="RTL"] .blocklyTreeRow {', "margin-left: 8px;", "}", ".blocklyTreeRow:not(.blocklyTreeSelected):hover {", "background-color: #f5f5f5;", "}", ".blocklyTreeSeparator {", "border-bottom: solid #e5e5e5 1px;", "height: 0;", "margin: 5px 0;", "}", ".blocklyTreeSeparatorHorizontal {", "border-right: solid #e5e5e5 1px;", "width: 0;", "padding: 5px 0;", "margin: 0 5px;", "}", ".blocklyTreeIcon {", "background-image: url(<<<PATH>>>/sprites.png);", "height: 0px;", "vertical-align: middle;", "width: 0px;", "}", ".blocklyTreeIconClosedLtr {", "background-position: -32px -1px;", "}", ".blocklyTreeIconClosedRtl {", "background-position: 0px -1px;", "}", ".blocklyTreeIconOpen {", "background-position: -16px -1px;", "}", ".blocklyTreeSelected>.blocklyTreeIconClosedLtr {", "background-position: -32px -17px;", "}", ".blocklyTreeSelected>.blocklyTreeIconClosedRtl {", "background-position: 0px -17px;", "}", ".blocklyTreeSelected>.blocklyTreeIconOpen {", "background-position: -16px -17px;", "}", ".blocklyTreeIconNone,", ".blocklyTreeSelected>.blocklyTreeIconNone {", "background-position: -48px -1px;", "}", ".blocklyTreeLabel {", "cursor: default;", "font-family:'Microsoft Yahei',sans-serif;", "font-size: 14px;", "padding: 0px 15px;", "vertical-align: top;", "}", ".blocklyToolboxDelete .blocklyTreeLabel {", 'cursor: url("<<<PATH>>>/handdelete.cur"), auto;', "}", ".blocklyTreeSelected .blocklyTreeLabel {", "color: #fff !important;", "}", ".blocklyWidgetDiv .goog-palette {", "outline: none;", "cursor: default;", "}", ".blocklyWidgetDiv .goog-palette-table {", "border: 1px solid #666;", "border-collapse: collapse;", "}", ".blocklyWidgetDiv .goog-palette-cell {", "height: 13px;", "width: 15px;", "margin: 0;", "border: 0;", "text-align: center;", "vertical-align: middle;", "border-right: 1px solid #666;", "font-size: 1px;", "}", ".blocklyWidgetDiv .goog-palette-colorswatch {", "position: relative;", "height: 13px;", "width: 15px;", "border: 1px solid #666;", "}", ".blocklyWidgetDiv .goog-palette-cell-hover .goog-palette-colorswatch {", "border: 1px solid #FFF;", "}", ".blocklyWidgetDiv .goog-palette-cell-selected .goog-palette-colorswatch {", "border: 1px solid #000;", "color: #fff;", "}", ".blocklyWidgetDiv .goog-menu {", "background: #fff;", "border-color: #ccc #666 #666 #ccc;", "border-style: solid;", "border-width: 1px;", "cursor: default;", "font: normal 13px Arial, sans-serif;", "margin: 0;", "outline: none;", "padding: 4px 0;", "position: absolute;", "overflow-x: hidden;", "overflow-y: hidden;", "max-height: 100%;", "overflow: auto;", "z-index: 20000;", "display: inline-block;", "}", ".blocklyWidgetDiv .goog-menuitem {", "color: #000;", "font: normal 13px Arial, sans-serif;", "list-style: none;", "margin: 0;", "padding: 4px 7em 4px 28px;", "white-space: nowrap;", "}", ".blocklyWidgetDiv .goog-menuitem.goog-menuitem-rtl {", "padding-left: 7em;", "padding-right: 28px;", "}", ".blocklyWidgetDiv .goog-menu-nocheckbox .goog-menuitem,", ".blocklyWidgetDiv .goog-menu-noicon .goog-menuitem {", "padding-left: 12px;", "}", ".blocklyWidgetDiv .goog-menu-noaccel .goog-menuitem {", "padding-right: 20px;", "}", ".blocklyWidgetDiv .goog-menuitem-content {", "color: #000;", "font: normal 13px Arial, sans-serif;", "}", ".blocklyWidgetDiv .goog-menuitem-disabled .goog-menuitem-accel,", ".blocklyWidgetDiv .goog-menuitem-disabled .goog-menuitem-content {", "color: #ccc !important;", "}", ".blocklyWidgetDiv .goog-menuitem-disabled .goog-menuitem-icon {", "opacity: 0.3;", "-moz-opacity: 0.3;", "filter: alpha(opacity=30);", "}", ".blocklyWidgetDiv .goog-menuitem-highlight,", ".blocklyWidgetDiv .goog-menuitem-hover {", "background-color: #d6e9f8;", "border-color: #d6e9f8;", "border-style: dotted;", "border-width: 1px 0;", "padding-bottom: 3px;", "padding-top: 3px;", "}", ".blocklyWidgetDiv .goog-menuitem-checkbox,", ".blocklyWidgetDiv .goog-menuitem-icon {", "background-repeat: no-repeat;", "height: 16px;", "left: 6px;", "position: absolute;", "right: auto;", "vertical-align: middle;", "width: 16px;", "}", ".blocklyWidgetDiv .goog-menuitem-rtl .goog-menuitem-checkbox,", ".blocklyWidgetDiv .goog-menuitem-rtl .goog-menuitem-icon {", "left: auto;", "right: 6px;", "}", ".blocklyWidgetDiv .goog-option-selected .goog-menuitem-checkbox,", ".blocklyWidgetDiv .goog-option-selected .goog-menuitem-icon {", "background: url(//ssl.gstatic.com/editor/editortoolbar.png) no-repeat -512px 0;", "}", ".blocklyWidgetDiv .goog-menuitem-accel {", "color: #999;", "direction: ltr;", "left: auto;", "padding: 0 6px;", "position: absolute;", "right: 0;", "text-align: right;", "}", ".blocklyWidgetDiv .goog-menuitem-rtl .goog-menuitem-accel {", "left: 0;", "right: auto;", "text-align: left;", "}", ".blocklyWidgetDiv .goog-menuitem-mnemonic-hint {", "text-decoration: underline;", "}", ".blocklyWidgetDiv .goog-menuitem-mnemonic-separator {", "color: #999;", "font-size: 12px;", "padding-left: 4px;", "}", ".blocklyWidgetDiv .goog-menuseparator {", "border-top: 1px solid #ccc;", "margin: 4px 0;", "padding: 0;", "}", ""];
Blockly.WidgetDiv = {};
...
Blockly.createMainWorkspace_ = function(a, b, c, d) {
    ...
    b.readOnly || b.hasScrollbars || e.addChangeListener(function() {
        if (!e.isDragging()) {
            ...
            if (a.contentTop < d || a.contentTop + a.contentHeight > a.viewHeight + d || a.contentLeft < (b.RTL ? a.viewLeft : c) || a.contentLeft + a.contentWidth > (b.RTL ? a.viewWidth : a.viewWidth + c))
...
Blockly.init_ = function(a) {
    ...
    b.languageTree && (a.toolbox_ ? a.toolbox_.init(a) : a.flyout_ && (a.flyout_.init(a), a.flyout_.show(b.languageTree.childNodes), a.flyout_.scrollToStart(), a.scrollX = a.flyout_.width_, b.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT && (a.scrollX *= -1), a.translate(a.scrollX, 0)));
...
Blockly.onKeyDown_ = function(a) {
    if (!Blockly.mainWorkspace.options.readOnly && !Blockly.utils.isTargetInput(a)) {
        ...
        if (27 == a.keyCode) Blockly.hideChaff();
            ...
            if (Blockly.mainWorkspace.isDragging()) return;
            Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.isMovable() && (67 == a.keyCode ? (Blockly.hideChaff(), Blockly.copy_(Blockly.selected)) : 88 == a.keyCode && (Blockly.copy_(Blockly.selected), b = !0));

...
function parseData (data) {
  ...
  var postData = '%7b"unic":'+ '"' + userObj.nickname + '"'
               ...
               + ',' + '"mac":' + '"' + eqObj.Mac + '"'
               + ',' + '"Did":' + '"' + eqObj.Did + '"' + '%7d';
//  alert(window.location.href = 'http://www.eggtoy.com/eggtoy/choose.html?' + postData);
  window.location.href = 'http://www.eggtoy.com/eggtoy/choose.html?' + postData;

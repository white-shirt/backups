Blockly.Blocks["blockly_pause"] = {
	init: function () {
		this.appendDummyInput().setAlign(Blockly.ALIGN_CENTRE).appendField("等待").appendField(new Blockly.FieldNumber(0, 1, 10, 1), "pauseTime").appendField("秒");
...
Blockly.Blocks['blockly_keepwalking_front'] = {
  init: function() {
    this.appendDummyInput()
        .setAlign(Blockly.ALIGN_CENTRE)
        .appendField("向前走")
        .appendField(new Blockly.FieldNumber(50, 1, 200, 0.5), "time")
        .appendField("秒 ")
        .appendField(" 速度")
        .appendField(new Blockly.FieldDropdown([["慢","50"], ["正常","80"], ["快","120"], ["超快","160"]]), "speed");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#f5821f");
 this.setTooltip("");
...
Blockly.Blocks['blockly_keepwalking_back'] = {
  init: function() {
    this.appendDummyInput()
        .setAlign(Blockly.ALIGN_CENTRE)
        .appendField("向后走")
...
Blockly.Blocks["blockly_rotate"] = {
	init: function () {
		this.appendDummyInput().setAlign(Blockly.ALIGN_CENTRE)
				.appendField("旋转")
				.appendField(new Blockly.FieldNumber(5.5, 1, 30, 0), "ROTATESTEP")
				.appendField("秒")
				.appendField("")
				.appendField(new Blockly.FieldDropdown([["顺时针","1"], ["逆时针", "0"]]), "dir")
				.appendField("")
				.appendField("速度")
				.appendField(new Blockly.FieldDropdown([["慢", "50"], ["正常", "80"], ["快", "120"], ["超快", "160"]]), "SPEED");
		this.setPreviousStatement(true, null);
...
Blockly.Blocks["blockly_differential"] = {
	init: function () {
		...
		this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField("时间").appendField(new Blockly.FieldNumber(5, 1, 10, 1), "TIME").appendField("秒");
		this.setInputsInline(false);
		this.setPreviousStatement(true, null);
		this.setNextStatement(true, null);
		this.setColour("#f5821f");
...
Blockly.Blocks['blockly_customizecolor'] = {
	init: function () {
		this.appendDummyInput()
			...
			.appendField("绿")
			.appendField(new Blockly.FieldNumber(0, 0, 255, 1), "green")
			.appendField("蓝")
			.appendField(new Blockly.FieldNumber(0, 0, 255, 1), "BLUE")
			.appendField(new Blockly.FieldDropdown([["慢闪", "5"], ["快闪", "20"], ["静止", "0"]]), "Blink")
			.appendField(new Blockly.FieldDropdown([["暗", "50"], ["亮", "250"], ["正常", "150"]]), "Brightness");
		this.setPreviousStatement(true, null);
		this.setNextStatement(true, null);
		this.setColour("#fec002");
		this.setTooltip("");
...
Blockly.Blocks['blockly_customeye'] = {
  init: function() {
    this.appendDummyInput()
		.appendField("点亮\"蛋仔\"的眼睛");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
	this.setColour("#fec002");
 	this.setTooltip("");
...
Blockly.Blocks["blockly_play"] = {
	init: function () {
		this.appendDummyInput().setAlign(Blockly.ALIGN_CENTRE).appendField("音乐").appendField(new Blockly.FieldDropdown([["随机播放", "0"], ["Head shoulders kness...", "41"], ["Bingo", "42"], ["Donkey", "43"], ["Food I Like", "44"], ["Little Star", "45"], ["Long long ago", "46"], ["乖乖大小姐", "47"], ["拍拍手", "48"], ["三只小熊", "49"], ["洋娃娃和小熊跳舞", "50"]]), "MUSIC").appendField(new Blockly.FieldDropdown([["等待", "0"], ["继续", "1"]]), "WAIT");
		this.setPreviousStatement(true, null);
		this.setNextStatement(true, null);
...
Blockly.Blocks["blockly_animal"] = {
	init: function () {
		this.appendDummyInput().setAlign(Blockly.ALIGN_CENTRE).appendField("动物").appendField(new Blockly.FieldDropdown([["随机播放", "0"], ["猫", "1"], ["狗", "2"], ["公鸡", "3"], ["狮子", "4"], ["大象", "5"], ["青蛙", "6"], ["绵羊", "7"], ["鸭子", "8"], ["马", "9"], ["啄木鸟", "10"]]), "animal").appendField(new Blockly.FieldDropdown([["等待", "0"], ["继续", "1"]]), "WAIT");
		this.setPreviousStatement(true, null);
		this.setNextStatement(true, null);
		this.setColour("#d80381");
		this.setTooltip("");
